#ttps://www.samproell.io/posts/yarppg/yarppg-face-detection-with-mediapipe/
import cv2
import numpy as np
...
image = cv2.imread("face-framing-braids-margot-robbie.png")  # read any image containing a face
